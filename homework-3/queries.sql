...
WHERE ship_via=2 AND customers.city='London' AND employees.city='London'
...
WHERE EXISTS
(SELECT * FROM order_details WHERE quantity=10 AND products.product_id=order_details.product_id)