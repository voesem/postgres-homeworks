...
ALTER TABLE order_details ADD COLUMN deleted_product int;
UPDATE order_details SET deleted_product=1
WHERE EXISTS (SELECT * FROM products WHERE discontinued = 1 AND products.product_id=order_details.product_id)
